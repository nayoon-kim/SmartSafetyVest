...
public class WorkerDto {
	...
	public WorkerDto(int director_id) {
		setDirector_id(director_id);
	}
	public WorkerDto(int worker_id, int report_signal) {
		setWorker_id(worker_id);
		setReport_signal(report_signal);
	}
	
	public WorkerDto(int worker_id, String vest_id, int warning_signal, double latitude, double longitude,
